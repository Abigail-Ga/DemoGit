...
public class SuperPharm_Sanity {
	...
	@Test(priority = 1, enabled = false, description = "Check search results in site")
	...
	@Test(priority = 2, enabled = false, description = "add product to cart")
	...
	@Test(priority = 3, enabled = false, description = "Remove product from cart")
